...
<table class="zebra">
	...
	<?php
			...
			foreach ($Suppliers as $sup):
				echo '<tr>';
				echo '<td>'.$count.'</td>'; 
				echo '<td>'.$sup['Supplier']['name'].'</td>';
				echo '<td>'.$sup['Supplier']['category'].'</td>';
				echo '<td>'.$sup['Supplier']['linkman'].'</td>';
				echo '<td>'.$sup['Supplier']['phone'].'</td>';
				echo '<td>'.$sup['Supplier']['address'].'</td>';
				echo '</tr>';
				$count++;
			endforeach;	
	?>
